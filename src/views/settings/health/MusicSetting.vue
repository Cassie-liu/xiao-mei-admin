      ...
      <div class="music-setting">
        ...
        <div class="content">
          <el-table :data="tableData" :loading="loading" size="small">
            ...
            <el-table-column label="上传时间"  property="uploadTime"></el-table-column>
      ...
      methods: {
        query () {
          this.tableData = [
            {
              name: '111111111',
              uploadTime: '2019-12-25 12:50:59'
            }
          ]
        },
        add () {},
        ...
        uploadMusics (file) {
          ...
          this.tableData.push({name: file.name, uploadTime: '2019-12-25 12:50:59'});
        }
      }
    }
</script>
